...
@section('content')
        ...
        <div class="auth-card">
            <div class="auth-card__inner">
                <div class="brand">
                    ...
                    <p class="subtitle">{{ config('app.name') }} account recovery</p>
                </div>
                ...
                <form class="form" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="field">
                        ...
                        <div class="control has-toggle">
                            ...
                            <button type="button" class="toggle" data-toggle-password="#password"
                    ...
                    <div class="field">
                        ...
                        <div class="control has-toggle">
                            ...
                            <button type="button" class="toggle" data-toggle-password="#password-confirm"
    ...
    <script>
        (function () {
            function setState(input, btn, isVisible) {
                input.type = isVisible ? 'text' : 'password';
                btn.setAttribute('aria-pressed', String(isVisible));
                var label = btn.getAttribute('data-label') || btn.getAttribute('aria-label') || 'Toggle password';
                btn.setAttribute('aria-label', isVisible ? label.replace('Show', 'Hide') : label.replace('Hide', 'Show'));
            }
