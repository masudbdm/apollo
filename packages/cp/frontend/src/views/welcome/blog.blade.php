                        ...
                        <div class="col-lg-6">
                            ...
                            <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-4 mb-2">
                                <div class="row align-items-center pb-1">
                                    <div class="col-sm-4">
                                        <a href="{{ route('singlePost', ['id' => $post->id , 'slug' => $post->slug])}}">
                                            <img src="{{ route('imagecache', [ 'template'=>'original','filename' => $post->fi() ]) }}" class="img-fluid border-radius-0" alt="Gadgets That Make Your Smartphone Even Smarter">
                                        </a>
                                    </div>
                        ...
                        <div class="mb-4 pb-2">
                            <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                <div class="row">
                                    <div class="col">
                                        <a href="{{ route('singlePost', ['id' => $post->id , 'slug' => $post->slug])}}">
                                            <img src="{{ route('imagecache', ['template' => 'original', 'filename' => $post->fi()]) }}" class="img-fluid border-radius-0" alt="Main Reasons To Stop Texting And Driving">
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
